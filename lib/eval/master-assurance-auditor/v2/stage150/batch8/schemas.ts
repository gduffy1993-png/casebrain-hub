...
export const BATCH8_SCHEMA_VERSION = "maa-v2-stage150-batch8-structured-adapter@1.1.0" as const;
...
/** Required exit set for overall exit_snapshots eligibility. */
...
export type Batch8AdapterResult<T> = {
  ...
  /** Records meeting the adapter's completeness bar. */
