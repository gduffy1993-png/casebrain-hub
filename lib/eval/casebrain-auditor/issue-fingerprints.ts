...
export const UNIVERSAL_DISCOVERY_PATTERNS: DiscoveryPattern[] = [
  ...
  {
    pattern: /\bpp-[a-z0-9-]+\b/i,
    fingerprint: "wording.reasoning_v2_internal_leak",
    issueFamily: "wording",
    severity: "HIGH",
    expected: "No proof-point or eval IDs in Reasoning V2 panel copy.",
    suggestedSharedFix: "sanitizeReasoningPublicText in lib/criminal/reasoning-v2.",
    demoBlocker: true,
  },
  {
    pattern: /artifacts\/casebrain-auditor/i,
    fingerprint: "wording.reasoning_v2_internal_leak",
    issueFamily: "wording",
    severity: "HIGH",
    expected: "No artifact paths in Reasoning V2 panel copy.",
    suggestedSharedFix: "sanitizeReasoningPublicText in lib/criminal/reasoning-v2.",
    demoBlocker: true,
  },
  {
