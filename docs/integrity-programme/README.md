...
| Phase 9 — N-case corpus | CLOSED — CORPUS_CONTAINMENT_PASS (`4f44530e1`) | `docs/integrity-programme/phase-9-checkpoint.md` | `docs/integrity-programme/phase-9-checkpoint.md` |
| Phase 10 — mutation & adversarial injection | COMPLETE (containment; not corpus PASS) — **STOP FOR REVIEW** | `docs/integrity-programme/phase-10-checkpoint.md` | COMPLETE (containment; not corpus PASS) — **STOP FOR REVIEW** | `docs/integrity-programme/phase-10-checkpoint.md` |
| Phase 11 | PENDING | |
