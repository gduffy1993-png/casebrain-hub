...
| Step | Work | Status |
|------|------|--------|
| 1 | Apply trust feedback DB migration (`20260628120000_trust_feedback.sql`) | Pending |
| 2 | Export/copy gate — Chase, Summary, court note, gap list clean outside app | Not started |
