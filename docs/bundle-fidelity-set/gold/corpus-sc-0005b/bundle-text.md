...
**Charge:** Fraud by abuse of position, Fraud Act 2006 s.4
**Stage:** Crown Court
**Case ID:** sc-0005b
**Recipe:** fraud__custody_pace_limited+duplicate_noisy_docs+interview_summary_no_transcript+timing_contradiction
...
**Defendant:** Morgan Drew
**Offence:** Fraud by abuse of position, Fraud Act 2006 s.4
...
7. Full bank export / source statements (outstanding)
8. Device / login audit material (outstanding)
9. Mailbox export (outstanding)
