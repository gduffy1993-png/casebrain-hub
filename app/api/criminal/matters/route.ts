...
export async function POST(request: Request) {
  try {
    ...
    const criminalRow: Record<string, unknown> = {
      ...
      custody_number: station.custodyNumber || null,
      police_station_name: station.policeStationName || null,
      client_initials: station.clientInitials || null,
      client_yob: station.clientYob ?? null,
      representation_type: station.representationType || null,
      risk_appropriate_adult: station.riskAppropriateAdult === true,
      risk_interpreter: station.riskInterpreter === true,
      risk_mental_health: station.riskMentalHealth === true,
      risk_medical_issues: station.riskMedicalIssues === true,
      initial_disclosure_received: station.initialDisclosureReceived ?? null,
      initial_disclosure_notes: station.initialDisclosureNotes || null,
