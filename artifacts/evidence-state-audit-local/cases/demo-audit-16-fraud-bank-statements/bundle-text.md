...
URN: 26/DA/016
Officer in case: DC Fraser 9021
...
MG6C/FRD/01 — Bank statement summaries IG/BNK/01 — served on bundle.
...
OFFICER STATEMENT — DC Fraser 9021

Bank summaries IG/BNK/01 are served. Full transaction export and source records are NOT on bundle. Account attribution to Isla Grant requires outstanding tracing material.

=== SECTION: BANK_RECORDS ===

EXHIBIT IG/BNK/01 — BANK STATEMENT SUMMARIES (served)
...
EXHIBIT LIST — R v Isla Grant

IG/BNK/01 — Bank statement summaries — SERVED — pages 6-7
FRD/02 — Full transaction export — NOT SERVED

=== SECTION: LISTING ===

Case management — 8 March 2027, Financial Crime Court.