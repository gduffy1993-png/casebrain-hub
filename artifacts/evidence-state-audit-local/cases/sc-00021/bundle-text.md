...
**Stage:** Crown Court
**Case ID:** sc-00021
**Recipe:** robbery-id__bwv_outstanding+cctv_stills_no_master+timing_contradiction+weapon_provenance_conflict
...
- CCTV stills without master export log — outstanding
...
| CCTV stills without master export log Outstanding Chase before fixing hearing position. |
