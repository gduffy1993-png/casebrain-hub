...
Charge sheet; MG5; MG6C schedule; draft complainant MG11; screenshot/message pack (TB/01); exhibit list; police attribution note.
...
MG6C/002 — Screenshot and message pack TB/01 — served on bundle.
...
I am Sam Okonkwo. Between January and March 2026 I received persistent messages on WhatsApp and SMS from a number I did not recognise.

=== SECTION: MG11 ===

I saved screenshots exhibited as TB/01. Police told me a phone was seized from Taylor Brookes. I have not seen the full phone download and cannot say who typed each message without subscriber/account records.

Statement not yet signed — final MG11 outstanding.

=== SECTION: SCREENSHOTS ===

EXHIBIT TB/01 — SCREENSHOT AND MESSAGE PACK (served)

Pack reference: DFU/TB/2026
...
EXHIBIT LIST — R v Taylor Brookes (26/DA/026)

TB/01 — Screenshot and message pack — SERVED — pages 7-8
TB/02 — Phone extraction summary — SERVED (summary only)
TB/03 — Draft complainant MG11 — SERVED (unsigned)
TB/04 — Subscriber/account data — NOT SERVED
TB/05 — Full phone download — NOT SERVED

=== SECTION: POLICE_NOTE ===

POLICE NOTE — DIGITAL ATTRIBUTION (DC Patel 4521)

Screenshot pack TB/01 is served. Attribution of sender identity for +44 7700 900226 is asserted but NOT fully proved: subscriber/account data and full phone download are outstanding.
