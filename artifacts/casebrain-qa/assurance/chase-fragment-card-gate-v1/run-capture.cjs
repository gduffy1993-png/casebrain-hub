/**
 * Live PR #101 preview capture: fragment/narrative chase-card gate.
 * Ahmed, Patel, Gauntlet Overview + Chase; Brookes + Vale Bell no-regress.
 * Gold20 only. Does not write the password into artefacts.
 *
 *   node artifacts/casebrain-qa/assurance/chase-fragment-card-gate-v1/run-capture.cjs
 */
...
const OUT = path.resolve("artifacts/casebrain-qa/assurance/chase-fragment-card-gate-v1");
...
const CASES = [
  {
    ...
    tabs: ["overview", "chase"],
    extraOk: (t) => /Holly Ahmed|What needs attention|DISCLOSURE CHASE/i.test(t),
  },
  {
    id: "patel",
    caseId: "ffddc1a8-b837-4bde-bb50-bc55be0e7626",
    tabs: ["overview", "chase"],
    extraOk: (t) => /Isaac Patel|What needs attention|DISCLOSURE CHASE/i.test(t),
  },
  {
    id: "gauntlet",
    caseId: "280e487c-3680-4eca-97f1-988828f448e2",
    tabs: ["overview", "chase"],
    extraOk: (t) => /Riley North|What needs attention|DISCLOSURE CHASE/i.test(t),
  },
  {
    id: "brookes-fresh",
    caseId: "95a2746e-d1d3-4f55-aad6-4fb41a7b428b",
    tabs: ["overview", "file"],
    extraOk: (t) => /Taylor Brookes|Intimidating a witness|Raw source extract/i.test(t),
  },
  {
    id: "vale-bell",
    caseId: "b6d8ed78-b475-4d78-bc44-a7ec1e5475f0",
    tabs: ["overview"],
    extraOk: (t) => /Vale Bell|drug driving|driver identity/i.test(t),
  },
];
...
(async () => {
  ...
  const report = {
    ...
    base: BASE,
    email: EMAIL,
    sha: process.env.PROOF_SHA || "9ef796ab9",
  };
  try {
      ...
      for (const tab of spec.tabs) {
        ...
        row.tabs[tab] = {
          ...
          flags: {
            ...
            searchRecord: /search record/i.test(body),
            mg6c001: /MG6C\/001/i.test(body),
