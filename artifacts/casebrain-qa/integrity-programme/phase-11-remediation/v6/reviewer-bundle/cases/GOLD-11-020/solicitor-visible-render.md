# GOLD-11-020 — solicitor-visible render (v6)
...
```text
Controlled evidence reference: CASE-02:demo-audit-03-bwv-custody
...
We are reviewing the papers for Casey Fry. This is early-stage — nothing is final until we have full disclosure and your instructions. A custody record extract is on the papers, but the full body-worn video export, complete custody record, and interview/PACE material are still outstanding.
