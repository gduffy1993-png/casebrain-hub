# GOLD-11-008 — solicitor-visible render (v6)
...
```text
Controlled evidence reference: cb-fresh-002-jordan-hale
...
```text
Officers attended following a call. There was contact between the defendant and officers. Body-worn video is referred to on the schedule but not attached. Custody record is extract only.
```
