# GOLD-11-011 — solicitor-visible render (v4)
...
```text
Controlled evidence reference: cb-found-2003-nguyen
Controlled source context (safely redacted for review)
Client label: Client
Allegation: R v Priya Nguyen — first appearance listing
...
```text
BWV / footage | not served | log only; clip outstanding
```
