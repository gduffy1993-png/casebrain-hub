# GOLD-11-009 — solicitor-visible render

**Stratum:** blocked_containment
**Fixture:** pilot-3-marcus-vale
...
```text
Resolved family: theft
Audit family seed: fraud_account_control
```
...
COPY UNAVAILABLE — Solicitor review required — output integrity check failed.
Blocked source (not repaired):
Crown / disclosure officer (confirm on file)
```
