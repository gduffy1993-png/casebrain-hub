# GOLD-11-003 — solicitor-visible render

**Stratum:** accepted_clean
**Fixture:** cb-found-2003-nguyen
...
```text
Resolved family: violence
Audit family seed: violence_domestic_assault
```
