# GOLD-11-004 — solicitor-visible render

**Stratum:** accepted_clean
**Fixture:** cb-found-2004-clarke
...
```text
Resolved family: motoring
Audit family seed: generic_motoring_provisional
```
...
• Outstanding source material on disclosure schedule
```
