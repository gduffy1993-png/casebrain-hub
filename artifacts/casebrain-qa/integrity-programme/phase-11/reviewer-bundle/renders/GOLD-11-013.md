# GOLD-11-013 — solicitor-visible render

**Stratum:** uncertain_family
**Fixture:** demo-audit-03-bwv-custody
**Source kind:** phase9_pack_seed
**Selection reason:** Phase 9 uncertain_family stratum
**Review focus:** Is uncertain / fail-closed presentation correct for the solicitor?
...
Audit family seed: assault_emergency_worker
```
