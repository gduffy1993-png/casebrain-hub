...
- 1500/1500 build: **yes**
- 0 FAIL: **yes**
- 0 emitted unsupported: **yes**
- 0 blocked: **yes**
- 0 banned words: **yes**
- All hard counters zero: **yes**

## Warning pressure (honest, not hidden)

- generic_mg6_wording: **0**
- repeated_wording: **2456**
- unclear_labels: **0**
- duplicate_bullets: **0**
- dense_internal_wording: **0**
- possible_false_suppression: **0**
- ocr_date_court_ambiguity: **0**
- partial_support_only: **39825**
- too_cautious_not_surfaced: **4208**

## Verdicts

- Safe to commit runner + pack-level summaries: **yes**
- Safe to scale to 2200 (hard-safety only): **yes**
- Core product change required now: **no**
- Note: partial_support_only still elevated (39825); mostly honest partial PDF/text support on missing medical/device material, not hidden FAILs.
