  ...
  return (
    <Card className="p-6">
      <div className="mb-4 p-3 rounded-lg border border-amber-500/30 bg-amber-500/10">
        <p className="text-sm text-amber-700 dark:text-amber-400">Template for professional use. Verify all facts and complete any items marked for solicitor input before reliance.</p>
      </div>
      <div className="flex items-center gap-2 mb-4">
        <Scale className="h-5 w-5 text-primary" />
        <h2 className="text-xl font-bold">Bail Application</h2>
        <Button
          variant="outline"
          size="sm"
          className="ml-auto"
      ...
      <div className="p-4 bg-primary/10 border border-primary/30 rounded">
        <h3 className="text-sm font-semibold mb-2">Ready-to-use draft (verify and complete before use)</h3>
