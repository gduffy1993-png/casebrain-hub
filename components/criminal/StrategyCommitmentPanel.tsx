    ...
    return (
      <Card className="p-6" data-strategy-commitment>
        ...
        {isDebug && (
          ...
          {/* When NOT committed: hint only — full Defence Plan is in Strategy tab */}
          {!isCommitted && (
            <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-3">
              <p className="text-xs text-muted-foreground text-center">
                Confirm a strategy to access the Defence Plan (Strategy tab).
              </p>
            </div>
          )}

          {/* Procedural Panels - Safety and Disclosure Timeline only */}
